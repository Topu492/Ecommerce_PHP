            ...
            <div class="col-lg-6 col-xl-4">
               <form action="" method="post">
                ...
                <div class="form-outline mb-4">
                    ...
                    placeholder="Enter Your Confirm Password" class="form-control" required="required">

                </div>
                <input type="submit" name="admin_registration" class="bg-info py-2 px-3"
                value="Register">
                <p class="small">Don you already have an account? <a href="admin_login.php" class="link-danger">Login</a></p>
               </form>
            </div>
        </div>
